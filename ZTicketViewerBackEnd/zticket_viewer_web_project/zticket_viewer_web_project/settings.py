"""
Django settings for zticket_viewer_web_project project.
...
SECRET_KEY = '#e%wurwzo!1)x*^kvx=vn*bs_%!$+^rfgoy4w^s_vb4#xt0k-d'
...
ROOT_URLCONF = 'zticket_viewer_web_project.urls'
...
WSGI_APPLICATION = 'zticket_viewer_web_project.wsgi.application'
